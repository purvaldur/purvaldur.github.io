...
$( document ).ready(function() {
	$('.overlay-content').animate({ opacity: '1'}, {duration: 1500, queue: false}, 'easeOutQuart');
	$('.overlay-content').animate({ marginTop: '18em'}, {duration: 1500, queue: false}, 'easeOutQuart');
	$('.arrow').delay(1000).animate({ opacity: '1'}, {duration: 1500, queue: true}, 'easeOutQuart');
